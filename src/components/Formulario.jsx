    ...
    <div className="md:w-1/2 lg:w-2/5 mx-5">
      ...
      className='bg-white shadow-md rounded-lg py-10 px-5 mb-10'>
        ...
        <div className='mb-5'>
          ...
          <label htmlFor="paciente" className='block text-gray-700 uppercase font-bold'>Nombre Paciente
          </label>
        ...
        <div className='mb-5'>
          <label htmlFor="padre" className='block text-gray-700 uppercase font-bold'>Nombre Madre/Padre
          </label>
          <input 
          id="padre"
          type="text" placeholder='Nombre del Madre/Padre' 
          className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md'
          value={propietario}
        ...
        <div className='mb-5'>
          ...
          <input 
          id="alta"
          type="date" placeholder='Email de contacto' 
          className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md'
          value={fecha}
